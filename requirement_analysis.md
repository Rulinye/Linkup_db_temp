...
대학생 프로젝트라는 현실적 제약 안에서, 다음 4가지 방법을 단계적·복합적으로 활용했습니다. 본 프로젝트의 1차 사용자 그룹과 팀원의 특성이 일치한다는 점을 활용하여, 외부 인터뷰 대신 팀 내부의 심층 토론을 핵심 수단으로 삼았습니다.
...
### 3.3 팀 내부 사용자 조사 (Focus Group Interview)

본 프로젝트의 타겟 사용자(장시간 앉아 있는 대학생, VDT 증후군 경험자)와 팀원 4명의 특성이 정확히 일치합니다. 모두가 대학생이며, 하루 평균 8시간 이상을 책상 앞에서 보내고, 거북목·허리 통증·손목 피로를 직접 경험하고 있습니다. 이 특성을 활용하여 1차 요구사항은 팀원 간의 심층 토론(Focus Group Interview 형식)으로 도출했습니다.

토론 세션에서 각자가 다음 항목을 공유했습니다.
...
향후 프로젝트가 확장될 경우 외부 사용자 테스트(UAT)로 본 단계의 결과를 검증할 계획입니다.
...
| FR-08 | 사용자는 운동 장소(사무실/집)를 선택할 수 있어야 한다. | M | 1.3 (데스크톱 환경) |
